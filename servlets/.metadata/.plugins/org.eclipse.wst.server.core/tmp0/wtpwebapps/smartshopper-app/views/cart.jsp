...
<body>
 ...
 %>
	...
	<h1>Shopping Cart !</h1>
	<div>
		<!-- <a class="btn btn-primary" ng-if="user" ng-click="saveCartItems()">Save</a> -->
		...
		%>
		<a class='btn btn-primary' href='/smartshopper-app/ViewOrders'>View Previous Orders</a> <br />
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<form action="/smartshopper-app/cart?type=delete" method="post">
				<input type="hidden" name="idToDelete" value="<%=i%>">
