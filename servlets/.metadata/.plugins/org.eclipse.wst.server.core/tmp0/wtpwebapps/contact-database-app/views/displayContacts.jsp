...
<body>
		...
		<%
			...
			for (int i = 0; i < contacts.size(); i++) {
				...
				out.println("<tr><td> "
						...
						+ "</td><td> "
						+ contact.getNumber()
						+ "</td><td><a href='/contact-database-app/EditContact?id="
						+ contact.getId()
	...
	<br>
	<a href="/contact-database-app/AddContact"><button>Add</button></a>
	<script type="text/javascript">
		function onDeleteClick(id) {
			if (confirm("Are you sure you want to delte this contact?"))
				window.location.href = "/contact-database-app/DeleteContact?id="
						+ id;
		}
		function onLogoutClick() {
			if (confirm("Are you sure you want to Logout?"))
				window.location.href = "/contact-database-app/Logout";
		}
	</script>
</body>
</html>